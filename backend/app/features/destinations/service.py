...
class DestinationService:
    ...
    async def build_connector(self, id: int) -> DestinationConnector:
        ...
        if destination.request_timeout is not None:
            advanced["request_timeout"] = destination.request_timeout
